...
> Check it out directly at [the website](https://jj.github.io/venezia-living-city) or the [interactive map of Venice with the high-betweenness coridor marked on it](venezia-corridor-map.html).
...
Check out [this summary with highlights and code](venezia-summary.html) for the paper.
